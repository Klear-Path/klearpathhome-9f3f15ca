            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-2 text-sm">
                ...
                <span className="text-primary-foreground/80">
                  410 Hopkins Ct<br />North Wales, PA 19454
                </span>
              </li>
              <li className="flex items-center gap-2 text-sm">
                <Mail className="w-4 h-4 text-primary-foreground/60 flex-shrink-0" />
                <a href="mailto:ErickMcKee@KlearPathHome.ORG" className="text-primary-foreground/80 hover:text-primary-foreground transition-colors">
                  ErickMcKee@KlearPathHome.ORG
                </a>
              </li>
              <li className="flex items-center gap-2 text-sm">
                <Phone className="w-4 h-4 text-primary-foreground/60 flex-shrink-0" />
                <a href="tel:+12159867246" className="text-primary-foreground/80 hover:text-primary-foreground transition-colors">
                  (215) 986-7246
                </a>
              </li>
              <li className="flex items-center gap-2 text-sm">
                <Phone className="w-4 h-4 text-primary-foreground/60 flex-shrink-0" />
                <a href="tel:+18444558883" className="text-primary-foreground/80 hover:text-primary-foreground transition-colors">
                  (844) 455-8883
                </a>
              </li>
            </ul>
